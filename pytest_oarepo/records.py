...
def merge_record_data(default_record_with_workflow_json):
    def _merge_data(custom_workflow=None, additional_data=None, add_default_workflow=True):
...
def draft_factory_record_object(record_service, merge_record_data):
    def record(client, *service_args, custom_workflow=None, additional_data=None, **service_kwargs):
        json = merge_record_data(custom_workflow, additional_data)
        draft = record_service.create(client.user_fixture.identity, json, *service_args, **service_kwargs)
        return draft._obj
...
def record_factory_record_object(record_service, draft_factory_record_object, urls):
    ...
    def record(client, custom_workflow=None, additional_data=None):
        draft = draft_factory_record_object(client, custom_workflow=custom_workflow, additional_data=additional_data)
...
def draft_factory(draft_factory_record_object, urls):
    def _create_draft(
        client, *service_args, custom_workflow=None, additional_data=None, expand=True, **service_kwargs
    ):
        draft = draft_factory_record_object(client, *service_args, custom_workflow=custom_workflow,
                                            additional_data=additional_data, **service_kwargs)
...
def record_with_files_factory(
    record_service, upload_file, draft_factory_record_object, default_record_with_workflow_json, urls
):
    def record(client, custom_workflow=None, additional_data=None):
