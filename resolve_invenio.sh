...
main() {
    ...
    # ── 4. Resolve versions and emit constraints ──────────────────────────────
    local resolved=0
    ...
    info "Done – $resolved constraint(s) written to stdout."
    [[ $resolved -gt 0 ]] || warn "No constraints could be resolved – verify your venv."
}
